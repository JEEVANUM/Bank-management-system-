...
<div class="columns">
	<div class="column is-offset-4">
		<h1 class="title has-text-white  pt-4">GAT BANK PLC </h1>
	</div>
</div>

<form action="backendtransfer.php" method="post">
	<div class="columns">
		<div class="tops column is-offset-4">
			...
			<input type="text" class="input is-outlined  column is-5"  placeholder="<?php echo $_SESSION['username']?>"><br>


			<label for=""  class="is-size-5 has-text-white">Current balance <?php echo $_SESSION['totalamount']?> </label><br>
			<input type="text" class="input is-outlined     column is-5" placeholder="<?php echo $_SESSION['totalamount']?>"><br>
