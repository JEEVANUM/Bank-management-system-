...
<div class="columns">
	<h1 class="title column is-offset-4-desktop pt-5 has-text-white">GAT BANK USER DASHBOARD</h1>
</div>
...
<div class="columns ml-4 mt-5">
	<div class="card column is-6">
		...
		<div class="card-content">
			...
			<?php
				$collect_from_database = "SELECT * FROM bnk WHERE accountnumber ='".$_SESSION['accountnumber']."' ";
			...
			<p class="is-size-5 has-text-weight-semibold pr-3">Account Number :  <?php  echo $_SESSION['accountnumber'];?></p>
...
<div class="columns ml-4">
	...
	<div class="card mt-6 ml-6 mb-6  pb-6">
		<header class="card-header title is-size-6">Card Details</header>
		<div class="card-content">
